...
def get_api_answer(current_timestamp):
    ...
    try:
        ...
        logging.error(f'Ошибка обработки json {error}')
        raise ValueError(f'Ошибка обработки json {error}')
...
def main():
    ...
    while True:
        try:            
            ...
            bot.send_message(TELEGRAM_CHAT_ID , f'Что-то пошло совсем не так: {error}')
